...
| 处置 | 字符 | 说明 |
|---|---|---|
| **① SimHei 直接可用** | ``· × ≥ ≤ ≈ → ← ↑ ─ ★ ☆ ▲ ● ◆ ■ ※ § ° ± ÷ ∞ □ ■ ① ② ③ ④ ⑤ ⑥ ⑦ ⑧ ⑨ ⑩`` ＋全部汉字/中文标点/全角 | 无需任何包裹 |
| **② SimHei 无、Helvetica 有 → 包 `<font face="Helvetica">`** | ``¥ £ ¢ •`` | 即 `fix_currency()` 在做的事 |
| **③ 两边都没有 → 禁用** | emoji（``⛔ ✅ ⚠ ⭐ 🔴 📌``…）、**全部非拉丁小币种符号**（``₩ ₺ ₽ ₹ ₦ ₱ ฿ ₫ ₸ ₼ ₾ ₿ ₴ ₲ ₡ ₣ ₨ ₪ ₮ ₵₤ ₧``）、勾选框（``☐ ☑ ✓ ✔ ✗ ✘``）、``† ‡ ❶``、拉丁扩展（``Ş ş ö ñ ã å ø ł ż č ² ³ © ® ™``） | **包裹也救不回来**——Helvetica 同样没有字形 |
